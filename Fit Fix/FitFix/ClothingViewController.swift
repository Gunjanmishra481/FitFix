...
class ClothingViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    let clothingItems = ClothingData.items  // Data source for clothing items
    ...
    private func setupCustomNavBar() {
        ...
        let containerStackView = UIStackView(arrangedSubviews: [titleLabel])
        ...
        NSLayoutConstraint.activate([
            ...
            customNavBarView.heightAnchor.constraint(equalToConstant: 5),
            
            containerStackView.centerYAnchor.constraint(equalTo: customNavBarView.centerYAnchor),
            containerStackView.leadingAnchor.constraint(equalTo: customNavBarView.leadingAnchor, constant: 6),
            containerStackView.trailingAnchor.constraint(equalTo: customNavBarView.trailingAnchor, constant: -6)
        ])
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageView.image = item.imageName // Assign the stored UIImage to the imageView
